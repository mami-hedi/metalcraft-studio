  ...
  head: () => ({
    meta: [
      ...
      { title: "SAM MECA — Construction métallique & chaudronnerie" },
      {
        name: "description",
        content:
          "Atelier SAM MECA : construction métallique, chaudronnerie, charpente métallique, confection de citernes et de remorques sur mesure.",
      },
      { name: "author", content: "SAM MECA" },
      { property: "og:title", content: "SAM MECA — Construction métallique & chaudronnerie" },
      {
