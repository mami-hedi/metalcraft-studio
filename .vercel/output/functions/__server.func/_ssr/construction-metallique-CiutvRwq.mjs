...
//#region node_modules/.nitro/vite/services/ssr/assets/construction-metallique-CiutvRwq.js
var import_jsx_runtime = require_jsx_runtime();
var construction_metallique1_default = "/assets/construction-metallique1-DDftqiGJ.jpg";
var construction_metallique2_default = "/assets/construction-metallique2-DXN33OaA.png";
var construction_metallique3_default = "/assets/construction-metallique3-CIeJrOUf.png";
function Page() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ServiceLayout, {
		...
		image: construction_metallique_default,
		...
		gallery: [
			construction_metallique1_default,
			construction_metallique2_default,
			construction_metallique3_default
		]
	});
}
//#endregion
